rem
rem     Script:         explain8i.sql
rem     Author:         Jonathan Lewis
rem     Purpose:        q and d to execute explain plan (Oracle 8i)
rem     Modification:   Marius Raicu
rem                     Adding the Distribution column(disponible in 8i)
rem                     Tested on 8.1.6,8.1.7
rem
rem     Preparation:
