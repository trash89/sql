--
-- Script : lock.sql
-- Purpose: Show the lock informations
-- To do  : test and validate on all releases
----------------------------------------------------------------------

@save_sqlplus_settings

set lines 200 pagesize 66 
break on Kill on  username on terminal 
column Kill heading 'KillString' format a10
...
column LAddr heading "ID1 - ID2" format a15 
column Lockt heading "Lock Type" format a35
